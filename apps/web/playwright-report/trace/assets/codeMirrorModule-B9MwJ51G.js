					...
					function Li(e, t, n) {
						if (n.to == null) {
							...
							return Li(
								e,
								r.line,
								cn(r.line.markedSpans, n.marker)
							);
						}
...
`
					...
					function ms(e, t) {
						t = qt(t);
						var n = f(t),
							r = (e.display.externalMeasured = new Po(
								e.doc,
								t,
								n
							));
						...
						if (o.nodeType == 3) {
							for (var h = 0; h < 4; h++) {
								for (
									;
									l &&
									Me(t.line.text.charAt(i.coverStart + l));
					...
					function ks(e, t, n, r, i) {
						...
						if (h) {
							var v = (e.options.lineWrapping ? Ss : ws)(
								e,
								t,
								n,
								o,
					...
					function Tr(e, t, n, r) {
						...
						if (
							!n &&
							ln(t).getAttribute('cm-not-content') == 'true'
						)
							return null;
						var o,
							l,
						...
						if (
							...
							var h =
								Le(u, u.length, e.options.tabSize) - u.length;
							s = L(
								s.line,
								Math.max(
									0,
									Math.round(
										(o - Ho(e.display).left) / Kr(e.display)
									) - h
								)
							);
						}
					...
					function Ts(e, t, n) {
						...
						(i.length == 0 || t >= r.viewTo || n <= r.viewFrom
							...
							: (r.viewFrom > t
									? (r.view = Gn(e, t, r.viewFrom).concat(
											r.view
										))
									: r.viewFrom < t &&
					...
					function Wi(e, t, n) {
						...
						if (r.other) {
							...
							((a.style.display = ''),
								...
								(a.style.height =
									(r.other.bottom - r.other.top) * 0.85 +
									'px'));
						}
					}
					function Qn(e, t) {
					...
					function rl(e) {
						e.hasFocus() ||
							(e.display.input.focus(), e.state.focused || Ri(e));
					}
					function Hi(e) {
						...
						for (
							...
							if (!a.hidden) {
								if (((i += a.line.height), b && N < 8)) {
									var v =
										a.node.offsetTop + a.node.offsetHeight;
									((u = v - n), (n = v));
								} else {
					...
					function Ps(e) {
						...
						(e.updatedDisplay && Vn(t),
							...
							n.maxLineChanged &&
								...
								((e.adjustWidthTo =
									qo(t, n.maxLine, n.maxLine.text.length)
										.left + 3),
					...
					function zs(e) {
						...
						if (
							...
							e.scrollTop != null &&
								ol(t, e.scrollTop, e.forceScroll),
					...
					function pl(e, t) {
						...
						if ((r && s) || (i && u)) {
							...
							if (r && !I && !z && o != null) {
								(i &&
									u &&
									yn(e, Math.max(0, a.scrollTop + i * o)),
					...
					function oi(e, t, n, r, i) {
						(i == null &&
							...
							pt(
								e,
								new At([$i(e.sel.primary(), t, n, i)], 0),
								r
							));
					}
					function Tl(e, t, n) {
					...
					function pt(e, t, n) {
						(li(e, t, n),
							Ys(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n));
					}
					function li(e, t, n) {
					...
					function Ol(e, t) {
						if (
							...
							var n = Zi(e, t);
							(kl(e, t, n, e.cm ? e.cm.curOp.id : NaN),
								Tn(e, t, n, wi(e, t)));
							var r = [];
							vr(e, function (i, o) {
								(!o &&
					...
					function Vr(e, t, n, r, i) {
						...
						if (
							...
							if (
								(u && (s.curOp.updateMaxLine = !0), o.collapsed)
							)
					...
					((kt.prototype = F(Dn.prototype, {
						...
						setGutterMarker: at(function (e, t, n) {
							return Ln(this, e, 'gutter', function (r) {
								var i =
									r.gutterMarkers || (r.gutterMarkers = {});
								return (
									(i[t] = n),
...
`
					...
					function ou(e, t) {
						if (
							b &&
							(!e.state.draggingText || +new Date() - Rl < 100)
						) {
							ar(t);
							return;
						}
...
`,
					...
					function $l(e) {
						(e.keyCode == 16 && (this.doc.sel.shift = !1),
							Ze(this, e));
					}
					function ea(e) {
						var t = this;
					...
					function Tu(e, t, n, r) {
						...
						if (
							...
							var h = ra(e, n, r.unit);
							r.extend
								? (l = $i(l, h.anchor, h.head, r.extend))
								: (l = h);
						}
						r.addNew
							? a == -1
					...
					function Du(e) {
						...
						((e.defineOption = n),
							...
							n(
								...
								!1,
								function (r, i) {
									return (r.getInputField().autocapitalize =
										i);
								},
								!0
							),
							...
							n('screenReaderLabel', null, function (r, i) {
								((i = i === '' ? null : i),
									r.display.input.screenReaderLabelChanged(
										i
									));
							}),
							n(
					...
					function Eu(e) {
						...
						((e.prototype = {
							...
							addKeyMap: function (r, i) {
								this.state.keyMaps[i ? 'push' : 'unshift'](
									fi(r)
								);
							},
							...
							hasFocus: function () {
								return (
									this.display.input.getField() == y(Y(this))
								);
							},
							isReadOnly: function () {
								return !!(
...
`)));
						...
						(je.prototype.readFromDOMSoon = function () {
							...
							this.readDOMTimeout == null &&
								(this.readDOMTimeout = setTimeout(function () {
									if (
										((e.readDOMTimeout = null), e.composing)
									)
										if (e.composing.done)
											e.composing = null;
										else return;
					...
					function da(e, t) {
						...
						return (
							(s.offset =
								s.collapse == 'right' ? s.end : s.start),
							s
						);
					}
					function Nu(e) {
					...
					function Ou(e, t, n, r, i) {
						...
						function k(x) {
							if (x.nodeType == 1) {
								...
								if (
									x.getAttribute('contenteditable') == 'false'
								)
									return;
					...
					function pi(e, t, n) {
						...
						if (t == e.display.lineDiv) {
							if (((r = e.display.lineDiv.childNodes[n]), !r))
								return rn(
									e.clipPos(L(e.display.viewTo - 1)),
									!0
								);
							((t = null), (n = 0));
						} else
...
`) > -1
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`));
							...
							(_ && (v = i.ownerDocument.defaultView.scrollY),
								r.input.focus(),
								_ &&
									i.ownerDocument.defaultView.scrollTo(
										null,
										v
									),
								r.input.reset(),
						...
						function H(d, S, w) {
							...
							if (d == 'endTag' || d == 'selfcloseTag') {
								...
								return (
									...
									d == 'selfcloseTag' ||
									b.autoSelfClosers.hasOwnProperty(te(m))
										? se(w, m)
										: (se(w, m),
											(w.context = new re(
												w,
						...
						return {
							...
							indent: function (d, S, w) {
								...
								if (y && y[1])
									...
									for (; m; ) {
										var P =
											b.contextGrabbers[te(m.tagName)];
										if (P && P.hasOwnProperty(te(y[2])))
											m = m.prev;
										else break;
									}
								for (; m && m.prev && !m.startOfLine; )
									m = m.prev;
						...
						function Ee(f, g, A, W, L) {
							...
							for (
								D.state = f,
									...
									D.cc = Z,
									D.style = g,
									f.lexical.hasOwnProperty('align') ||
										(f.lexical.align = !0);
								;
				...
				(function (C) {
					...
					(C.defineMode('python', function (N, _) {
						...
						function de(S, w, m) {
							...
							if (S.match(ne)) {
								var le =
									S.current().toLowerCase().indexOf('f') !==
									-1;
								return le
									? ((w.tokenize = ze(
											S.current(),
						...
						function J(S, w) {
							S.sol() &&
								((w.beginningOfLine = !0), (w.dedent = !1));
		...
		La ||
			...
			(function (Et, zt) {
				(function (C) {
					...
					function H(m, y) {
						var P = y.cpp11RawStringDelim.replace(
								/[^\w\s]/g,
								'\\$&'
							),
							le = m.match(new RegExp('.*?\\)' + P + '"'));
						return (
							le ? (y.tokenize = null) : m.skipToEnd(),
							'string'
						);
					}
					function Ee(m, y) {
						...
						return function (z, X) {
							...
							if (X.local)
								if (X.local.end && z.match(X.local.end)) {
									...
									return (
										(X.local = X.localState = null),
										we
									);
								} else {
									var we = X.local.mode.token(
											z,
											X.localState
										),
										te;
